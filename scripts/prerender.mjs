...
const routes = {
  ...
  '/wand-entfernen-rhein-main': { title: 'Wand entfernen im Rhein-Main-Gebiet | Räume öffnen | Radex', description: 'Nichttragende Wände fachgerecht entfernen und moderne Wohnräume schaffen. Professionelle Planung und Umbauten im gesamten Rhein-Main-Gebiet.' },
