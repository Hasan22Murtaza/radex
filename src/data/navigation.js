...
export const badsanierungCards = [
  {
    ...
    desc: 'Ihr Badezimmer komplett neu gestalten – von der Planung über Sanitär, Elektro und Fliesen bis zur schlüsselfertigen Übergabe.',
    cta: 'Mehr erfahren',
    icon: Bath,
  ...
  },
  {
    ...
    desc: 'Mehr Komfort, mehr Bewegungsfreiheit und eine moderne Dusche – individuell geplant und professionell umgesetzt.',
    cta: 'Mehr erfahren',
    icon: ShowerHead,
    image: '/img/bad1.webp',
  },
  {
    ...
    desc: 'Bodengleiche Duschen, komfortable Bewegungsflächen und durchdachte Lösungen für ein sicheres Badezimmer.',
    cta: 'Mehr erfahren',
    icon: Accessibility,
    image: '/img/bad1.webp',
  },
  {
    ...
    desc: 'Auch kleine Räume können hochwertig, funktional und modern gestaltet werden.',
    cta: 'Mehr erfahren',
    icon: DoorOpen,
    image: '/img/bad1.webp',
  },
  {
    ...
    desc: 'Nutzen Sie unseren Kostenrechner und erhalten Sie eine erste Orientierung zu den möglichen Investitionskosten.',
    cta: 'Mehr erfahren',
    icon: Calculator,
  ...
  },
  {
    ...
    desc: 'Erfahren Sie Schritt für Schritt, wie Ihre Badsanierung mit Radex geplant und umgesetzt wird.',
    cta: 'Mehr erfahren',
    icon: ListOrdered,
