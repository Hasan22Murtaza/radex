...
export const badsanierungKostenSeoIntro = (
  <>
    <img
      src="/img/badsanierung-kosten-rhein-main-radex.webp"
      alt="Badsanierung Kosten – Planung und Preisfaktoren im Rhein-Main-Gebiet"
      className="w-full rounded-xl mb-6"
      loading="lazy"
    />
    <p className={p}>
      <strong>Badsanierung Kosten – womit Sie bei einem neuen Bad rechnen sollten</strong>
    </p>
        <p className={p}>
...
export const badsanierungKostenSeoSections = [
  {
    id: "was-kostet-ein-neues-bad-und-warum-lasst-sich-das-so-schwer-pauschal-sagen",
    title: "Was kostet ein neues Bad – und warum lässt sich das so schwer pauschal sagen?",
    content: (
      <>
        <p className={p}>
          Die Frage nach den Kosten einer Badsanierung ist die erste, die fast jeder stellt – und die am wenigsten pauschal zu beantworten ist. Das liegt nicht daran, dass Handwerker keine konkreten Aussagen treffen wollen. Es liegt daran, dass zwei Bäder mit gleicher Grundfläche völlig unterschiedliche Ausgangssituationen haben können: unterschiedliche Leitungsführungen, unterschiedliche Abdichtungszustände, unterschiedliche Wünsche an Ausstattung und Gestaltung. Diese Faktoren bestimmen die Kosten weit mehr als die reine Quadratmeterzahl.
        </p>
        <p className={p}>
  ...
  {
    id: "die-faktoren-hinter-den-badsanierung-kosten-was-den-preis-wirklich-bestimmt",
    title: "Die Faktoren hinter den Badsanierung Kosten – was den Preis wirklich bestimmt",
    content: (
      <>
        <p className={p}>
        ...
        <img
          src="/img/bad-kosten-planung-materialien-radex.webp"
          alt="Badsanierung Kostenfaktoren – Planung und Materialien"
          className="w-full rounded-xl mb-6"
          loading="lazy"
        />
        <h4 className={h4}>Badgröße – die Grundlage, aber nicht alles</h4>
        <p className={p}>
        ...
        <h4 className={h4}>Leitungsführung – neu verlegen oder weiternutzen?</h4>
        <p className={p}>
  ...
  {
    id: "ausstattung-dusche-fliesen-und-elektro-die-weiteren-kostenpositionen",
    title: "Ausstattung, Dusche, Fliesen und Elektro – die weiteren Kostenpositionen",
    content: (
      <>
        <p className={p}>
        ...
        <img
          src="/img/badausstattung-preisfaktoren-radex.webp"
          alt="Ausstattung und Preisfaktoren einer Badsanierung"
          className="w-full rounded-xl mb-6"
          loading="lazy"
        />
        <h4 className={h4}>Dusche statt Badewanne – und was dabei wirklich anfällt</h4>
        <p className={p}>
        ...
        <h4 className={h4}>Elektroarbeiten Bad – ein Pflichtposten, keine Option</h4>
        <p className={p}>
        ...
        <h4 className={h4}>Sanitärobjekte und Armaturen – großer Preishebel</h4>
        <p className={p}>
  ...
  {
    id: "barrierefreies-bad-und-ruckbau-zwei-positionen-mit-eigenem-gewicht",
    title: "Barrierefreies Bad und Rückbau – zwei Positionen mit eigenem Gewicht",
    content: (
      <>
        <h4 className={h4}>Barrierefreies Bad – Mehrkosten, die sich rechnen</h4>
        <p className={p}>
        ...
        <h4 className={h4}>Planung und Koordination – Kosten, die sich auszahlen</h4>
        <p className={p}>
        ...
        <p className={p}>
          Radex übernimmt als Generalunternehmer die vollständige Koordination aller Gewerke. Das bedeutet für Sie: ein Ansprechpartner, ein Zeitplan, eine Verantwortung. Die Planungsleistung fließt in das Gesamtangebot ein – sichtbar und kalkulierbar. Eine gute Planung ist auch der Schlüssel zu einer verlässlichen Kostenschätzung: Wer sein Bad präzise geplant hat, bekommt ein belastbares Angebot. Mehr dazu auf der Seite <Link to="/badplanung">Badplanung</Link>.
        </p>
        <h4 className={h4}>Qualität der Ausführung – warum der Preis nicht allein entscheidet</h4>
        <p className={p}>
  ...
  {
    id: "badbudget-planen-wie-eine-seriose-kostenschatzung-entsteht",
    title: "Badbudget planen – wie eine seriöse Kostenschätzung entsteht",
    content: (
      <>
        <p className={p}>
        ...
        <img
          src="/img/badbudget-badsanierung-radex.webp"
          alt="Badbudget planen für eine Badsanierung"
          className="w-full rounded-xl mb-6"
          loading="lazy"
        />
        <p className={p}>
        ...
        <h4 className={h4}>Was in einer Badsanierung Kostenkalkulation steckt</h4>
        <p className={p}>
        ...
        <p className={p}>
          Mehr zu Festpreisangeboten und was dabei zu beachten ist, lesen Sie auf der Seite <Link to="/badsanierung-festpreis">Badsanierung Festpreis</Link>. Wer eine vollständige Badsanierung plant, findet auf der Seite <Link to="/badsanierung/badezimmer-sanieren">Komplettbadsanierung</Link> eine detaillierte Beschreibung aller Leistungsphasen.
        </p>
      </>
    ),
  },
  {
    id: "badsanierung-kosten-transparent-einschatzen-was-radex-dabei-leitet",
    title: "Badsanierung Kosten transparent einschätzen – was Radex dabei leitet",
    content: (
      <>
        <p className={p}>
        ...
        <h4 className={h4}>Kostenlose Bestandsaufnahme</h4>
        <p className={p}>
        ...
        <h4 className={h4}>Aufgeschlüsselte Angebote</h4>
        <p className={p}>
        ...
        <h4 className={h4}>Generalunternehmer</h4>
        <p className={p}>
  ...
  {
    id: "badsanierung-kosten-im-rhein-main-gebiet-wo-radex-tatig-ist",
    title: "Badsanierung Kosten im Rhein-Main-Gebiet – wo Radex tätig ist",
    content: (
      <>
        <p className={p}>
        ...
        <p className={p}>
          Die vollständige Übersicht aller Städte und Gemeinden, in denen Radex Badsanierungen durchführt, finden Sie auf der Seite <Link to="/einsatzgebiete-rhein-main">Einsatzgebiete</Link>.
        </p>
        <h4 className={h4}>Unsere Einsatzorte</h4>
        <ul className={ul}>
          <li>Rödermark</li>
  ...
  {
    id: 'haeufige-fragen-zu-den-badsanierung-kosten',
    title: 'Häufige Fragen zu den Badsanierung Kosten',
    content: (
      <>
        <h4 className={h4}>Was beeinflusst die Kosten einer Badsanierung?</h4>
        <p className={p}>
        ...
        <h4 className={h4}>Warum unterscheiden sich Badkosten so stark?</h4>
        <p className={p}>
        ...
        <h4 className={h4}>Wie kann man ein Badbudget seriös planen?</h4>
        <p className={p}>
        ...
        <h4 className={h4}>Was kostet eine Badsanierung pro Quadratmeter?</h4>
        <p className={p}>
        ...
        <h4 className={h4}>Lohnt sich ein barrierefreies Bad trotz höherer Kosten?</h4>
        <p className={p}>
        ...
        <p className={p}>
          Radex erstellt Ihnen nach einer kostenlosen Bestandsaufnahme ein verbindliches Angebot, das den realen Aufwand Ihrer Situation abbildet. Mehr zu dem Thema finden Sie auf der Seite{' '}
          <Link to="/badsanierung-festpreis">Badsanierung Festpreis</Link>.
        </p>
      </>
    ),
  },
