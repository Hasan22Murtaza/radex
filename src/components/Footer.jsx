...
const footerColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Schimmel- & Asbestsanierung', to: '/schimmel-asbest-sanierung-rhein-main' },
      { label: 'Schadstoffsanierung', to: '/schadstoffsanierung-rhein-main' },
      { label: 'Asbestsanierung', to: '/asbestsanierung-rhein-main' },
      { label: 'Schimmelsanierung', to: '/schimmelsanierung-rhein-main' },
...
const expandableGroups = [
  ...
  },
  {
    ...
    links: [
      { label: 'Innenausbau & Umbau Rhein-Main', to: '/innenausbau-umbau-rhein-main' },
      { label: 'Innenausbau Wohnung Rhein-Main', to: '/innenausbau-wohnung-rhein-main' },
      { label: 'Innenausbau Haus Rhein-Main', to: '/innenausbau-haus-rhein-main' },
      { label: 'Trockenbau Rhein-Main', to: '/trockenbau-rhein-main' },
      { label: 'Wand entfernen Rhein-Main', to: '/wand-entfernen-rhein-main' },
      { label: 'Gewerbe- & Objektsanierung Rhein-Main', to: '/gewerbe-objektsanierung-rhein-main' },
      { label: 'Kontakt', to: '/#kontakt' },
      { label: 'Datenschutz', to: '/datenschutz' },
      { label: 'Impressum', to: '/impressum' },
    ],
